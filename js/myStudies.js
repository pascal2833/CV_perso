...
educationFr.schoolsAndOnlineCourses.forEach(function(element) {
...
.data(educationEs.schoolsAndOnlineCourses)
.enter().append("rect")
...
.text(educationEs.complements.subTitleStudies)
;

var infoFormationsTitle = svg.append("g")
.append("text")
...
.style("fill", colorStrokeCircleGraph)
.style("font-size", "1.04em")
.text(educationEs.complements.subTitleFormations)
;

// ----- Gérer quand la souris s'en va de la zone ou svg : ------- //
